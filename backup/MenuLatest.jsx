  ...
  return (
    ...
    >
        ...
        {allCocktails.map((cocktail, index) => {
          ...
          return (
            <button
              ...
              } md:text-3xl text-xl cursor-pointer hover:text-yellow hover:border-yellow pb-2 transition-colors font-modern-negra`}
              key={cocktail.id}
            >
              {cocktail.name}
            </button>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex max-md:flex-col gap-10 md:items-center justify-between w-full -translate-y-52">
